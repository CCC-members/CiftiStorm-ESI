function save_output_files(properites,modality,MEEGs,HeadModels,iHeadModel,scalp,outerS,innerS,surf)
%%
...
for m=1:length(MEEGs)
    ...
    Shead = scalp.Sh;
    save(fullfile(output_subject_dir,'scalp','scalp.mat'),'Cdata','Shead');
    disp ("-->> Saving inner skull file");
    Sinn = innerS.Sinn;
