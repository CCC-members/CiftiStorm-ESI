function varargout = script_process_mri_deface( varargin )
...
function sProcess = GetDescription() %#ok<DEFNU>
    ...
    sProcess.options.overwrite.Group   = 'output';
     ...
     % Option: Overwrite
    sProcess.options.mri_th.Comment = 'mri_th';
    sProcess.options.mri_th.Type    = 'mri_th';
    sProcess.options.mri_th.Value   = 0.75;
...
function OutputFiles = Run(sProcess, sInputs) %#ok<DEFNU>
    ...
    OPTIONS.mri_th = sProcess.options.mri_th.Value;
    % Get subject name
...
function [DefacedFiles, errMsg] = Compute(MriFiles, OPTIONS)
    ...
    Def_OPTIONS = struct(...
        'Method',        'spm', ...
        'MNIplane',      [0, 0, 1, OPTIONS.mri_th], ... % 'MNIplane',      [-0.00036476, -0.01128325, 0.00980049, 0.001025580777], ...
        'isOverwrite',   0, ...
        'isInteractive', 1, ...
        'isDefaceHead',  1);
