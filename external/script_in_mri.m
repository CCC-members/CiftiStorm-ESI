function [MRI, vox2ras] = script_in_mri(MriFile, FileFormat, isInteractive, isNormalize)
%%
% changed line 117 with [MRI, vox2ras] = script_in_mri_nii(MriFile, 0, []); % Function automatically detects right byte order
%%
...
switch (FileFormat)   
    ...
    case {'Nifti1', 'Analyze'}
        if isInteractive
            [MRI, vox2ras] = script_in_mri_nii(MriFile, 0, []); % Function automatically detects right byte order
        else
