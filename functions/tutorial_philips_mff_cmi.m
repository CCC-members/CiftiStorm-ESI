function tutorial_philips_mff_cmi(tutorial_dir,subID,ID)
...
AnatDir   = fullfile(tutorial_dir, subID, 'T1-only', 'ciftify', subID, 'T1w');
RawFile   = fullfile(tutorial_dir, subID, 'Functional', 'EEG', 'raw', 'mff_format', ID);

% ======= CREATE PROTOCOL =======
% The protocol name has to be a valid folder name (no spaces, no weird characters...)
ProtocolName = 'TutorialPhilipsMFF1_2';
...
sFiles = bst_process('CallProcess', 'process_import_surfaces', sFiles, [], ...
    'subjectname', SubjectName, ...
    'cortexfile1', {fullfile(AnatDir,'Native',[subID,'.L.midthickness.native.surf.gii']), 'GII-MNI'}, ...
    'cortexfile2', {fullfile(AnatDir,'Native',[subID,'.R.midthickness.native.surf.gii']), 'GII-MNI'}, ...
    'nvertcortex', 8000);
