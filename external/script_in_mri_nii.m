function [sMri, vox2ras] = script_in_mri_nii(MriFile, isReadMulti, isApply)
%%
% changed line 148 with [vox2ras, sMri] = script_cs_nii2bst(sMri, hdr.nifti.vox2ras, isApply); 
%%
...
if ~isempty(hdr.nifti) && ~isempty(hdr.nifti.vox2ras)
    [vox2ras, sMri] = script_cs_nii2bst(sMri, hdr.nifti.vox2ras, isApply);
end
